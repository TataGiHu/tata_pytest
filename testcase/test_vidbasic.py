...
def test_soc_vidbasic():
    ...
    cmd = "cd " + remote_path + "/data;rm -f /dev/shm/*;\
        ...
        ../bin/test_ocv_vidbasic opencv_input.mp4 vidbasic 10 0 > soc_vidbasic.log;\
        md5sum vidbasic*png > soc_vidbasic_MD5.log"
    ...
    for line in stderr.readlines():
        print(line.strip())
    ssh.close()
    file_path = test_path+"/log/soc_vidbasic.log"
    md5_path = test_path+"/log/soc_vidbasic_MD5.log"
    ...
    remote_log_path = remote_path + "/pytest_daily/soc_vidbasic.log"
    remote_MD5_path = remote_path + "/pytest_daily/soc_vidbasic_MD5.log"
