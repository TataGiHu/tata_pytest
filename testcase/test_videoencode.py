...
def test_soc_videoencode():
    ...
    cmd = "cd " + remote_path + "/data;rm -f /dev/shm/*;\
        ...
        ../bin/test_ff_video_encode opencv_input.mp4 ff_video_encode.mp4 H264 416 240 0 I420 3000 30 > soc_videoencode.log;\
        md5sum ff_video_encode*.mp4 > soc_videoencode_MD5.log"
    ...
    for line in stderr.readlines():
        print(line.strip())
    ssh.close()
    file_path = test_path+"/log/soc_videoencode.log"
    md5_path = test_path+"/log/soc_videoencode_MD5.log"
    ...
    remote_log_path = remote_path + "/pytest_daily/soc_videoencode.log"
    remote_MD5_path = remote_path + "/pytest_daily/soc_videoencode_MD5.log"
